...
# --- Configuration ---
# The codec to use for the output video. 'mp4v' is a good choice for MP4.
...
def adjust_thresholds(bad_apple_video_path, fg_video_path, bg_video_path, start_second, duration):
    """
    Displays a live preview with trackbars from a specific point in the video
    to allow the user to adjust the Luma Keying threshold.
    Returns the chosen threshold values.
    """
...
def main():
    ...
    """
    print("IF TWO VIDEOS EXIST IT CAN BE BAD APPLE !\n")
    print("Internet.")
